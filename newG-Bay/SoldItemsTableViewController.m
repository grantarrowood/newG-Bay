//
//  SoldItemsTableViewController.m
//  newG-Bay
//
...
#import "SoldItemsTableViewController.h"
#import "DetailsViewController.h"
#import "AllItemsTableViewCell.h"


@interface SoldItemsTableViewController ()
{
...
@implementation SoldItemsTableViewController
...
- (void)configureDatabase {
    ...
    _refHandle = [ref observeEventType:FIRDataEventTypeChildAdded withBlock:^(FIRDataSnapshot *snapshot) {
        ...
        NSString *theString = @"sold";
        if ([isSold isEqualToString:theString]) {
