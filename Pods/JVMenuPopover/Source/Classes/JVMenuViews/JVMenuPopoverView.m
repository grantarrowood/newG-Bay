...
{
    return CGRectMake(0, 70, self.frame.size.width, self.frame.size.height-70);
}
...
{
    if (self.menuItems.menuTitles.count >=12 ) {
...
//        self.rowCount++;
//    }
    cell.textLabel.text = self.menuItems.menuTitles[indexPath.row];
