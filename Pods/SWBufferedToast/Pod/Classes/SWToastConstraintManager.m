...
#define kButtonHeightSecondAction   60.0f;
#define kButtonHeightThirdAction    60.0f;
#define kTextfieldHeightUsername    70.0f;
#define kTextfieldHeightPassword    70.0f;
#define kTextfieldHeightFirstName    70.0f;
#define kTextfieldTitleDistance     -10.0f;
#define kLoginToastHeight           (IPAD ? 285.0f : 255.0f);
#define kRegisterToastHeight           (IPAD ? 310.0f : 270.0f);
                                      ...
                                      andParentView:(SWBufferedToast *)parentView
{
    switch (toast.toastType) {
        ...
        case SWBufferedToastTypeRegister:
        {
            ...
            //Add view's constraints
            float width = kLoginToastMultiplierWidth;
            float height = kRegisterToastHeight;
            NSLayoutConstraint *widthConstraint;
...
+ (void)applyTextfieldConstraintsForFirstNameField:(UITextField *)firstNameField
                                   toPasswordField:(UITextField *)passwordField
                                           onToast:(SWToast *)toast
{
    [toast addSubview:firstNameField];
    firstNameField.translatesAutoresizingMaskIntoConstraints = NO;
    firstNameField.userInteractionEnabled = YES;
    float height = kTextfieldHeightFirstName;
    
    NSLayoutConstraint *widthConstraint         = [NSLayoutConstraint constraintWithItem:firstNameField
                                                                               attribute:NSLayoutAttributeWidth
                                                                               relatedBy:0
                                                                                  toItem:toast
                                                                               attribute:NSLayoutAttributeWidth
    ...
    NSLayoutConstraint *heightConstraint        = [NSLayoutConstraint constraintWithItem:firstNameField
                                                                               attribute:NSLayoutAttributeHeight
                                                                               relatedBy:0
                                                                                  toItem:nil
                                                                               attribute:NSLayoutAttributeNotAnAttribute
    ...
    NSLayoutConstraint *constraintX             = [NSLayoutConstraint constraintWithItem:firstNameField
                                                                               attribute:NSLayoutAttributeCenterX
                                                                               relatedBy:NSLayoutRelationEqual
                                                                                  toItem:toast
                                                                               attribute:NSLayoutAttributeCenterX
    ...
    NSLayoutConstraint *topConstraint           = [NSLayoutConstraint constraintWithItem:firstNameField
                                                                               attribute:NSLayoutAttributeTop
                                                                               relatedBy:NSLayoutRelationEqual
...
+ (void)applyButtonConstraintsForButton:(UIButton *)button
                        toPasswordField:(UITextField *)secondTextField
                                onToast:(SWToast *)toast
{
...
+ (void)applyButtonConstraintsForSecondButton:(UIButton *)button
                                ToFirstButton:(UIButton *)firstButton
                                      onToast:(SWToast *)toast
{
    [toast addSubview:button];
    button.translatesAutoresizingMaskIntoConstraints = NO;
    button.userInteractionEnabled = YES;
    float height = kButtonHeightSecondAction;
...
+ (void)applyButtonConstraintsForThirdButton:(UIButton *)button
                              ToSecondButton:(UIButton *)secondButton
                                     onToast:(SWToast *)toast
{
    [toast addSubview:button];
    button.translatesAutoresizingMaskIntoConstraints = NO;
