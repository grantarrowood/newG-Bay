    ...
    if (self) {
        ...
        self.toastView = [[SWToast alloc] initLoginToastWithColour:toastColor
                                                     ...
                                                     passwordTitle:passwordTitle
                                                         doneTitle:doneTitle
                                              differentActionTitle:differentActionTitle
                                    ...
                                    onView:(UIView*)parentView
{
    ...
    if (self) {
        self.backgroundColor = backgroundColor;
        self.parentView = parentView;
        self.toastView = [[SWToast alloc] initRegisterToastWithColour:toastColor
                                                                title:title
                                                        usernameTitle:usernameTitle
                                                        passwordTitle:passwordTitle
...
{
    [self.delegate didAttemptCreateWithUsername:username
                                       Password:password
...
{
    [self.delegate didBeginRegistration:self];
}

- (void)backButtonTapped
{
    [self.delegate didBeginBack:self];
}

- (void)continueButtonTapped
{
    [self.delegate didBeginContinue:self];
}
